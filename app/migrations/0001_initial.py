# Generated by Django 2.2 on 2019-04-30 14:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.CharField(choices=[('av', 'Aventura'), ('rl', 'Religioso'), ('aa', 'AutoAjuda'), ('fc', 'Ficçao'), ('sf', 'Ficçao'), ('tr', 'Terror'), ('hq', 'Historias em Quadrinhos'), ('mg', 'Mangá'), ('rm', 'Romance'), ('bg', 'Biografia')], max_length=2)),
